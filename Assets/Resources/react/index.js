...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@font-face{font-family:\"Rubik Bubbles\";src:resource(\"Fonts/RubikBubbles\")}*{font-family:\"Rubik Bubbles\"}.padding-md{padding:12px}.padding-lg{padding:24px}.spacer{flex-grow:1}.flex-column{display:flex;flex-direction:column}.flex-row{display:flex;flex-direction:row}.align-center{align-items:center}.justify-center{justify-content:center}.button{border:none;margin:0;padding:0;background:rgba(0,0,0,0);font-size:64px;color:#fff;padding-top:24px;padding-bottom:24px;padding-left:32px;padding-right:32px;background:#a28dbd;border-radius:48px}.button:active{background-color:#e4ccd6;transform:scale(1.1)}.button:hover{background-color:#e4ccd6;transform:scale(1.1)}.score{color:#fff;font-size:24px}.score.text{padding-right:20px}.debug-ui{display:flex;flex-direction:column;padding:6px;position:absolute;width:100%;height:100%;background-color:rgba(0,0,0,0)}.debug-ui .footer{display:flex;flex-direction:row}.debug-ui .text{color:#fff;font-size:24px}.debug-ui .button{font-size:16px;border-radius:12px;border-width:1px;border-style:solid;border-color:#fff;height:40px;width:120px;padding:4px}.main-menu{display:flex;flex-direction:column;justify-content:center;align-items:center;height:100%;background:url(\"resource:DivergentDreams.png\");background-size:cover;background-position:center}.main-menu .content{margin-top:470px;display:flex;flex-direction:column;align-items:center}.main-menu .content>*:not(:first-child){margin-top:48px}.main-menu .title{margin-top:-128px;margin-bottom:128px;text-align:center;color:#fff;font-size:64px}.hud .score{font-size:36px}.pause-menu{height:100%}.pause-menu .container{padding-left:24px;padding-right:24px;color:#fff}.pause-menu .container .button{font-size:32px}.pause-menu .container>*:not(:first-child){margin-top:24px}.pause-menu .black-bar{display:flex;flex-direction:column;position:fixed;top:0;left:0;right:0;height:60px;background:linear-gradient(90deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8) 20%, rgba(0, 0, 0, 0.8) 80%, rgba(0, 0, 0, 0.5))}.pause-menu .gradient-rule{height:1px;width:100%;background-image:linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.8), transparent)}.gameover{display:flex;flex-direction:column;justify-content:center;align-items:center;height:100%}.gameover .title{margin-top:-128px;margin-bottom:128px;text-align:center;color:#fff;font-size:82px}.gameover .score{font-size:40px;text-align:center;justify-content:center;margin-top:20px}.gameover .latest{margin-top:-64px;font-size:64px}.gameover .ranking{margin-bottom:64px;font-size:64px}.gameover .mainMenuButton{margin-top:64px;margin-bottom:-64px;font-size:48px;width:340px;align-self:center}.leaderboard{display:flex;flex-direction:column;justify-content:center;align-items:center;background:url(\"resource:DivergentDreams_altered.png\");background-size:cover;background-position:center;height:100%}.leaderboard .title{margin-top:-200px;margin-bottom:100px;color:#fff;font-size:82px;text-align:center}.leaderboard .content{display:flex;flex-direction:column;justify-content:center;align-items:center;margin-bottom:100px}.leaderboard .content>*:not(:first-child){margin-top:24px}.leaderboard .score{display:flex;flex-direction:row;font-size:32px}.leaderboard .button{font-size:32px}", ""]);
// Exports
...
;// CONCATENATED MODULE: ./node_modules/@reactunity/renderer/dist/src/helpers/hooks/use-globals.js
...
;// CONCATENATED MODULE: ./node_modules/@reactunity/renderer/dist/src/helpers/hooks/use-reactive-value.js
...
var dist_shim = isServerEnvironment ? useSyncExternalStore$1 : useSyncExternalStore$2;
var useSyncExternalStore =  true ? function (module) {
  return module.useSyncExternalStore;
}(react_namespaceObject) : dist_shim;
...
function Button(_ref){var text=_ref.text,_onClick=_ref.onClick,_ref$isDisabled=_ref.isDisabled,isDisabled=_ref$isDisabled===void 0?false:_ref$isDisabled,_ref$className=_ref.className,className=_ref$className===void 0?"":_ref$className;return/*#__PURE__*/(0,jsx_runtime.jsx)("button",{className:"button ".concat(className," ").concat(isDisabled?"disabled":""),onClick:function onClick(){_onClick&&_onClick();},children:text});}
;// CONCATENATED MODULE: ./src/mainMenu.tsx
function MainMenu(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"main-menu",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Start Game",onClick:function onClick(){gameLifecycleManager.StartGame(0,true);}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Leaderboard",onClick:function onClick(){gameLifecycleManager.ToLeaderboard();}})]})});}
;// CONCATENATED MODULE: ./src/pauseMenu.tsx
function PauseMenu(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"pause-menu",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"black-bar",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"container flex-row align-center spacer",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"text",children:"Paused"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Main Menu",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Continue",onClick:function onClick(){gameLifecycleManager.UnpauseGame();}})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"gradient-rule"})]})});}
;// CONCATENATED MODULE: ./src/instructions.tsx
function Instructions(){var globals=useGlobals();return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"black-bar",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{className:"title",children:"Speaker"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"gradient-rule"}),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:"message",children:"Text"})]})});}
;// CONCATENATED MODULE: ./src/score.tsx
// I had to put the score and score text in separate spans because Unity is dumb
var Score=function Score(props){return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("span",{"class":"score text",children:"Score: "}),/*#__PURE__*/(0,jsx_runtime.jsx)("span",{"class":"score",children:props.value})]});};/* harmony default export */ const src_score = (Score);
;// CONCATENATED MODULE: ./src/hud.tsx
function Hud(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;var score=useReactiveValue(globals.score);return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"hud",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"flex-row padding-md",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(src_score,{value:score}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"})]})});}
;// CONCATENATED MODULE: ./src/gameOver.tsx
function GameOver(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;var status=useReactiveValue(globals.status);var canContinue=useReactiveValue(globals.canContinue);var leaderboardScores=useReactiveValue(globals.leaderboardScores);var LatestScore=leaderboardScores.LatestScore,LatestRanking=leaderboardScores.LatestRanking,BestScore=leaderboardScores.BestScore,BestRanking=leaderboardScores.BestRanking,GlobalBestScore=leaderboardScores.GlobalBestScore,NumberScores=leaderboardScores.NumberScores;var title=status;if(canContinue){title="Let's keep dreaming~";}var intermediateScreen=/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Continue",onClick:function onClick(){gameLifecycleManager.ToNextLevel();}}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"score flex-row padding-md",children:/*#__PURE__*/(0,jsx_runtime.jsx)(src_score,{value:globals.score.Value})})]});var endingScreen=/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"score latest",children:"Score:  ".concat(LatestScore)}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"score ranking",children:"Ranking:  #".concat(LatestRanking," out of ").concat(NumberScores," players")}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"score",children:"My Best Score:  ".concat(BestScore==0?"N/A":BestScore)}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"score",children:"My Best Ranking:  #".concat(BestRanking==0?"N/A":BestRanking)}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"score",children:"World Top Score:  ".concat(GlobalBestScore==0?"N/A":GlobalBestScore)}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{className:"mainMenuButton",text:"Main Menu",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}})]});return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"gameover",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:title}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[canContinue&&intermediateScreen,!canContinue&&endingScreen]})]});}
;// CONCATENATED MODULE: ./src/leaderboard.tsx
function Leaderboard(){var globals=useGlobals();var gameLifecycleManager=globals.gameLifecycleManager;var leaderboardScores=useReactiveValue(globals.leaderboardScores);var LatestScore=leaderboardScores.LatestScore,LatestRanking=leaderboardScores.LatestRanking,BestScore=leaderboardScores.BestScore,BestRanking=leaderboardScores.BestRanking,GlobalBestScore=leaderboardScores.GlobalBestScore,NumberScores=leaderboardScores.NumberScores;return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"leaderboard",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"title",children:"Leaderboard"}),/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"score",children:"My Best Score:  ".concat(BestScore==0?"N/A":BestScore)}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"score",children:"My Best Ranking:  #".concat(BestRanking==0?"N/A":BestRanking," out of ").concat(NumberScores," players")}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"score",children:"World Top Score:  ".concat(GlobalBestScore==0?"N/A":GlobalBestScore)})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"Main Menu",onClick:function onClick(){gameLifecycleManager.ReturnToMainMenu();}})]});}
;// CONCATENATED MODULE: ./src/debug.tsx
function Debug(){var globals=useGlobals();var route=useReactiveValue(globals.route);var gameState=useReactiveValue(globals.debugGameState);var gameLifecycleManager=globals.gameLifecycleManager;var isDebugModeEnabled=useReactiveValue(globals.debugModeEnabled);return isDebugModeEnabled&&/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"debug-ui",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"footer",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"flex-column",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"text",children:"Debug"}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"text",children:"UI Route: ".concat(route)}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"text",children:"Game State: ".concat(gameState)}),(gameState=="GameStarted"||gameState=="GamePaused")&&/*#__PURE__*/(0,jsx_runtime.jsx)(Button,{text:"End Level",onClick:function onClick(){gameLifecycleManager.EndLevel();}})]})})]});}
;// CONCATENATED MODULE: ./src/index.tsx
function App(){var globals=useGlobals();var route=useReactiveValue(globals.route);var navigate=useNavigate();(0,react.useEffect)(function(){navigate(route);},[route,navigate]);return/*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment,{children:[/*#__PURE__*/(0,jsx_runtime.jsxs)(Routes,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/",element:/*#__PURE__*/(0,jsx_runtime.jsx)("view",{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/mainMenu",element:/*#__PURE__*/(0,jsx_runtime.jsx)(MainMenu,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/pauseMenu",element:/*#__PURE__*/(0,jsx_runtime.jsx)(PauseMenu,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/instructions",element:/*#__PURE__*/(0,jsx_runtime.jsx)(Instructions,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/hud",element:/*#__PURE__*/(0,jsx_runtime.jsx)(Hud,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/gameOver",element:/*#__PURE__*/(0,jsx_runtime.jsx)(GameOver,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/leaderboard",element:/*#__PURE__*/(0,jsx_runtime.jsx)(Leaderboard,{})})]}),/*#__PURE__*/(0,jsx_runtime.jsx)(Debug,{})]});}_render(/*#__PURE__*/(0,jsx_runtime.jsx)(MemoryRouter,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(App,{})}));
})();
